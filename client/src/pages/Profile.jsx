...
//import { errorHandler } from "../../../api/util/error";
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="text-sm text-center">
          ...
          <span className="text-red-700">Error Image Upload(Image must be less than 2mb)</span>) : filePerc > 0 && filePerc < 100 ? (
            <span className="text-slate-700">{`Uploading ${filePerc}%`}</span>) : filePerc === 100 ? (<span className="text-green-700">Image Successfully Uploaded</span>) : ("")}
        </p>
        ...
        className="bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-80">{loading ? 'Loading...' : 'Update'}</button>
      </form>
